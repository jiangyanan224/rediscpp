#ifndef MP11_FUNCTION_HPP_INCLUDED
#define MP11_FUNCTION_HPP_INCLUDED
...
#include <mp11/detail/mp_void.hpp>
...
#if MP11_WORKAROUND(MP11_MSVC, < 1920) || MP11_WORKAROUND(MP11_GCC, != 0)
...
#endif  // #ifndef MP11_FUNCTION_HPP_INCLUDED
