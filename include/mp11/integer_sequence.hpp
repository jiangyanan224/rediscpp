#ifndef MP11_INTEGER_SEQUENCE_HPP_INCLUDED
#define MP11_INTEGER_SEQUENCE_HPP_INCLUDED
...
#define MP11_HAS_MAKE_INTEGER_SEQ
#endif
#endif
...
#if defined(MP11_HAS_MAKE_INTEGER_SEQ)
...
template <class T, T N>
struct make_integer_sequence_impl
    : iseq_if_c<N == 0, iseq_identity<integer_sequence<T> >, iseq_if_c<N == 1, iseq_identity<integer_sequence<T, 0> >, make_integer_sequence_impl_<T, N> > >
{
};
...
#endif  // defined(MP11_HAS_MAKE_INTEGER_SEQ)
...
#endif  // #ifndef MP11_INTEGER_SEQUENCE_HPP_INCLUDED
