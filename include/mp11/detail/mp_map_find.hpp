#ifndef MP11_DETAIL_MP_MAP_FIND_HPP_INCLUDED
#define MP11_DETAIL_MP_MAP_FIND_HPP_INCLUDED
...
#if MP11_WORKAROUND(MP11_MSVC, < 1930)
...
#endif  // #if !MP11_WORKAROUND( MP11_MSVC, < 1930 )
...
#endif  // #ifndef MP11_DETAIL_MP_MAP_FIND_HPP_INCLUDED
