#ifndef MP11_DETAIL_MP_PLUS_HPP_INCLUDED
#define MP11_DETAIL_MP_PLUS_HPP_INCLUDED
...
#if defined(MP11_HAS_FOLD_EXPRESSIONS) && !MP11_WORKAROUND(MP11_MSVC, != 0) && !MP11_WORKAROUND(MP11_CLANG, != 0)
...
#if MP11_WORKAROUND(MP11_GCC, < 40800)
...
{
    static const decltype(T1::value + T2::value + T3::value + T4::value + T5::value + T6::value + T7::value + T8::value + T9::value + T10::value +
                          mp_plus_impl<T...>::type::value) _v = T1::value + T2::value + T3::value + T4::value + T5::value + T6::value + T7::value + T8::value +
                                                                T9::value + T10::value + mp_plus_impl<T...>::type::value;
    using type = std::integral_constant<typename std::remove_const<decltype(_v)>::type, _v>;
};
...
struct mp_plus_impl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T...>
{
    static const auto _v = T1::value + T2::value + T3::value + T4::value + T5::value + T6::value + T7::value + T8::value + T9::value + T10::value +
...
#endif  // #ifndef MP11_DETAIL_MP_PLUS_HPP_INCLUDED
