#ifndef MP11_DETAIL_MP_FOLD_HPP_INCLUDED
#define MP11_DETAIL_MP_FOLD_HPP_INCLUDED
...
#include <mp11/detail/mp_defer.hpp>
#include <mp11/detail/mp_rename.hpp>
...
template <template <class...> class L, class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8, class T9, class V,
...
#endif  // #ifndef MP11_DETAIL_MP_FOLD_HPP_INCLUDED
