...
#ifndef REDIS_ADAPTER_RESPONSE_TRAITS_HPP
#define REDIS_ADAPTER_RESPONSE_TRAITS_HPP

#include <redis/error.hpp>
#include <redis/resp3/type.hpp>
#include <redis/ignore.hpp>
...
struct result_traits
{
    ...
    static auto adapt(Result& r) noexcept
    {
...
#endif  // REDIS_ADAPTER_RESPONSE_TRAITS_HPP
