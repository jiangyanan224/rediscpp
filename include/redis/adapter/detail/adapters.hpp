...
#ifndef REDIS_ADAPTER_ADAPTERS_HPP
#define REDIS_ADAPTER_ADAPTERS_HPP
...
namespace redis::adapter::detail
{

// Serialization.

template <class T>
auto boost_redis_from_bulk(T& i, std::string_view sv, std::error_code& ec) -> typename std::enable_if<std::is_integral<T>::value, void>::type
{
...
inline void boost_redis_from_bulk(bool& t, std::string_view sv, std::error_code&)
{
    t = *sv.data() == 't';
}

inline void boost_redis_from_bulk(double& d, std::string_view sv, std::error_code& ec)
{
#ifdef _LIBCPP_VERSION
...
void boost_redis_from_bulk(std::basic_string<CharT, Traits, Allocator>& s, std::string_view sv, std::error_code&)
{
...
public:
    ...
    void operator()(Result& result, resp3::basic_node<std::string_view> const& n, std::error_code& ec)
    {
...
public:
    ...
    void operator()(Result& result, resp3::basic_node<std::string_view> const& nd, std::error_code& ec)
    {
...
#endif  // REDIS_ADAPTER_ADAPTERS_HPP
