...
#ifndef REDIS_RESP3_NODE_HPP
#define REDIS_RESP3_NODE_HPP
 ...
 *  `std::string` or `static_string` etc.
 *
...
{
    return a.aggregate_size == b.aggregate_size && a.depth == b.depth && a.data_type == b.data_type && a.value == b.value;
};
