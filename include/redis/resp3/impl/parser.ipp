...
void to_int(int_type& i, std::string_view sv, std::error_code& ec)
{
...
std::size_t parser::get_consumed() const noexcept
{
    return consumed_;
}
...
auto parser::consume_impl(type t, std::string_view elem, std::error_code& ec) -> parser::node_type
{
